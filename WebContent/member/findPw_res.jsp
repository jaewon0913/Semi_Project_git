...
<body>
   ...
   <table style="text-align: center;margin: auto;">
      ...
      <h1 style="font-family: HanSans;color:#333333;font-size:30px;font-style: italic;line-height: 2.0em; text-align: center;" >find my pw</h1>
     
    
      <tr height="30px">
         <td id="td_my">${dto.member_name }님의 비밀번호는</td> <td id="id_res">${dto.member_pw }</td><td id="td_my">입니다.</td>
