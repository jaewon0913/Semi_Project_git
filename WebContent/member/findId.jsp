...
<div align = "center">
	<h1 style="font-family: HanSans;color:#333333;font-size:30px;font-style: italic;line-height: 2.0em">find my id</h1>
	<form action = "member.do" method = "post">
		...
		<table id="table_my" border = "1">
			...
			<tr>
				<th id="th_my">Name</th>
				<td id="td_my"><input type = "text" name = "name" id="text" placeholder="성함을 입력해주세요."/></td>
			</tr>
			<tr>
				<th id="th_my">E-mail</th>
				<td id="td_my"><input type = "text" name = "email" id="text"placeholder="회원가입시 작성했던 이메일을 입력해주세요."/></td>
			</tr>
			<tr>
				<td colspan = "2" align = "center">
					<input type="button" value="취소" onclick="location.href='mainhome_real.jsp'" id="cancle_btn"/>
