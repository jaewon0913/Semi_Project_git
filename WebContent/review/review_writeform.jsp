...
<body>
	...
	<div id="review_write_out">
		<div id="review_write_in" align="center">
			<form method="post" action="${pageContext.request.contextPath }/upload.do?command=review_writeform" enctype="multipart/form-data">
				<table id="table_my">
					<tr>
						<th>destination:</th>
						<td colspan="2" align="center"><select name="category"
					...
					<tr>
						<th>writer:</th>
						<td style="font-size: 20px;" align="center">${id.member_id }
						<input type="hidden" name="id" value=${id.member_id } style="float: left;"></td>
					</tr>
					<tr>
						<th>title:</th>
					...
					<tr>
						...
						<input type="button" value="Cancle" onclick="location.href='${pageContext.request.contextPath }/review.do?command=reviewboard&pagenum=1&contentnum=10'" id="cancle_btn">
						</td>
					</tr>
				</table>
			</form>
