...
<body>
   ...
   <div data-text-content="true"
         ...
         class="" spellcheck="false">Review_reply</div>
   <div id="review_write_out">
   <div id="review_write_in">
   <form method="post" action="review.do?command=answerinsert">
   <input type="hidden" name="boardno" value="${boardno }">
   <input type="hidden" name="pagenum" value="${pagenum }">
   <table id="table_my">
      <tr>
         <th>destination: </th>   
         <td colspan="2" align="center" style="float: center;border-color: #ccc; width: 130px;height:25px;">
      ...
      <tr>
         <th>writer:</th>
         <td style="font-size: 20px;">${id.member_id }<input type="hidden" name="id" value="${id.member_id}" style="float: left;" ></td>
      </tr>
      ...
      <td colspan="2">
         ...
         <input type="button" value="Cancle" onclick="location.href='review.do?command=reviewboard&pagenum=1&contentnum=10'" id="cancle_btn">
      </td>
      </tr>
   </table>
   </form>
